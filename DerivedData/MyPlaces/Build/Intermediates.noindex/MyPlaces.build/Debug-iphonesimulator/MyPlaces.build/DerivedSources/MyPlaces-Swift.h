...
#ifndef MYPLACES_SWIFT_H
#define MYPLACES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyPlaces",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8MyPlaces11AppDelegate")
...
SWIFT_CLASS("_TtC8MyPlaces26CategoryPickerTVController")
@interface CategoryPickerTVController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8MyPlaces17CurrentLocationVC")
@interface CurrentLocationVC : UIViewController <CLLocationManagerDelegate>
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified getButton;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewWillDisappear:(BOOL)animated;
- (IBAction)getLocation:(UIButton * _Nonnull)sender;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (void)timeOut;
...
SWIFT_CLASS("_TtC8MyPlaces7HudView")
...
@interface Location (SWIFT_EXTENSION(MyPlaces))
...
SWIFT_CLASS("_TtC8MyPlaces12LocationCell")
...
SWIFT_CLASS("_TtC8MyPlaces34LocationDetailsTableViewController")
@interface LocationDetailsTableViewController : UITableViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified addressLabel;
...
@interface LocationDetailsTableViewController (SWIFT_EXTENSION(MyPlaces)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC8MyPlaces17MapViewController")
...
@interface MapViewController (SWIFT_EXTENSION(MyPlaces)) <MKMapViewDelegate>
...
SWIFT_CLASS("_TtC8MyPlaces26SavedLocationsTVController")
@interface SavedLocationsTVController : UITableViewController
- (void)viewDidLoad;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
...
@interface SavedLocationsTVController (SWIFT_EXTENSION(MyPlaces)) <NSFetchedResultsControllerDelegate>
...
SWIFT_CLASS("_TtC8MyPlaces13SceneDelegate")
